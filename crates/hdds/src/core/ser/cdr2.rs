...
//! CDR2 v2 header encoding/decoding (magic, version, options).
//!
...
impl<'a> EncoderLE<'a> {
    ...
    pub fn offset(&self) -> usize {
        crate::trace_fn!("EncoderLE::offset");
        self.cursor.offset()
    }
}
...
impl<'a> DecoderLE<'a> {
    ...
    pub fn offset(&self) -> usize {
        crate::trace_fn!("DecoderLE::offset");
        self.cursor.offset()
    }
}
