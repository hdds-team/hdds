...
//! ADLINK OpenSplice DDS dialect encoder
//!
//! **Vendor ID**: 0x0102
//! **Status**: Stub
//!
//! Note: OpenSplice is now deprecated in favor of Cyclone DDS
//!
...
/// ADLINK OpenSplice encoder
pub struct OpenSpliceEncoder;
...
impl DialectEncoder for OpenSpliceEncoder {
    fn build_spdp(
        &self,
        _: &Guid,
        _: &[SocketAddr],
        ...
        Err(EncodeError::UnsupportedDialect("OpenSplice"))
    }
