...
//! Dust DDS dialect encoder (Atostek)
//!
//! **Vendor ID**: 0x011A
//! **Status**: Stub
//!
...
/// Dust DDS encoder (Atostek)
pub struct DustEncoder;
...
impl DialectEncoder for DustEncoder {
    fn build_spdp(
        &self,
        _: &Guid,
        _: &[SocketAddr],
        ...
        Err(EncodeError::UnsupportedDialect("DustDDS"))
    }
