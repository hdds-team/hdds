...
/// InterCOM DDS encoder
pub struct InterComEncoder;
...
impl DialectEncoder for InterComEncoder {
    fn build_spdp(
        &self,
        _: &Guid,
        _: &[SocketAddr],
        ...
        Err(EncodeError::UnsupportedDialect("InterCOM"))
    }
